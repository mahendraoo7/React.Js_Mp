...
const Navbar = () => {
  ...
  return (
    <>
      <div className="mahendra w-full h-28 flex justify-around items-center z-50 sticky top-0">
          ...
          <div className="flex items-center justify-between ml-5">
            ...
            <div className="flex items-center space-x-4 mr-1">
              <NavLink to="/cart">
                ...
                <span className="absolute top-9 right-20 transform translate-x-1/2 -translate-y-1/2 border rounded-full px-1  text-[#fff] bg-[#ff0000] text-xs">0</span>
              </NavLink>

              <NavLink to="/wishlist">
                <FaHeart className="text-2xl text-gray-950 hover:text-[#ff0000] mr-5" />
                <span className="flex absolute top-8 justify-center items-center transform translate-x-1/2 -translate-y-1/2 border rounded-full h-[17px] w-[17px]  text-[#fff] bg-[#ff0000] text-xs">0</span>
              </NavLink>
